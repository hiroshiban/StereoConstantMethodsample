function StereoConstantMethodsample(subjID,acq,displayfile,stimulusfile,gamma_table,overwrite_flg,force_proceed_flag)
...
%    as ./subjects/(subjID)/results/(today)/(subjID)_StereoConstantMethodsample_results_run_(run_num).mat
%
%
% [example]
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
return;
% function StereoConstantMethodsample
